...
const session_reader_1 = require("../utils/session-reader");
const context_bridge_1 = require("../utils/context-bridge");
const reader = new session_reader_1.SessionReader();
const bridge = new context_bridge_1.ContextBridge();
...
function deleteSmokeSessions(args) {
    ...
    const smokeSessions = allSessions.filter(s => s.id.toLowerCase().includes('smoke') ||
